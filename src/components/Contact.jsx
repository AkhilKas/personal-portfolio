...
export default function Contact() {
  ...
  const contactReasons = [
    ...
    { value: 'academic', label: 'Academic Discussion', icon: '🎓' },
  ...
  const socialLinks = [
    {
      ...
      color: 'hover:text-red-400 dark:hover:text-red-400 light:hover:text-red-500'
    },
    {
      name: 'LinkedIn',
      ...
      color: 'hover:text-blue-400 dark:hover:text-blue-400 light:hover:text-blue-600'
    },
    {
      name: 'GitHub',
      value: '/akhilesh',
      ...
      color: 'hover:text-gray-300 dark:hover:text-gray-300 light:hover:text-gray-700'
    },
    {
      name: 'Google Scholar',
      ...
      color: 'hover:text-blue-300 dark:hover:text-blue-300 light:hover:text-blue-600'
    }
  ];
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full py-3 px-6 rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2 ${
                  isSubmitting
                    ? 'bg-gray-600 dark:bg-gray-600 light:bg-gray-200 text-gray-300 dark:text-gray-300 light:text-gray-500 cursor-not-allowed'
              ...
              {submitStatus === 'success' && (
                <div className="p-4 bg-green-500/10 dark:bg-green-500/10 light:bg-green-50 border border-green-500/20 dark:border-green-500/20 light:border-green-300 rounded-lg">
                  <p className="text-green-400 dark:text-green-400 light:text-green-700 text-sm font-medium">
              ...
              {submitStatus === 'error' && (
                <div className="p-4 bg-red-500/10 dark:bg-red-500/10 light:bg-red-50 border border-red-500/20 dark:border-red-500/20 light:border-red-300 rounded-lg">
                  <p className="text-red-400 dark:text-red-400 light:text-red-700 text-sm font-medium">
          ...
          <div className="space-y-8">
                ...
                {socialLinks.map((link) => (
                  ...
                  >
                    ...
                    <div className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity">
                      <svg className="w-5 h-5 text-gray-500 dark:text-gray-500 light:text-gray-400" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="bg-white dark:bg-gray-800 light:bg-white rounded-xl p-8 border border-gray-700 dark:border-gray-700 light:border-gray-200 shadow-none dark:shadow-none light:shadow-sm">
              ...
              <div className="space-y-3 text-gray-700 dark:text-gray-300 light:text-gray-700">
                ...
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-green-400 dark:text-green-400 light:text-green-500 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                  </svg>
                  <span>Boston, MA (EST)</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-purple-400 dark:text-purple-400 light:text-purple-500 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
